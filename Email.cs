   ...
   public class Email
    {
        ...
        */
        ...
        public void sendEmailTo(List<string> destinatarios, string asunto, string cuerpo, string nombreEvento)  //LA LISTA DE EMAILS ES SIEMPRE DEL EVENTO 61 PARA PROBAR EN LA CLASE User.cs REVISAR AL JUNTAR CON TODOS
        {
            MailMessage mail = new MailMessage();
            mail.From = new MailAddress("noreply.asuma@gmail.com", "ASUMA");
